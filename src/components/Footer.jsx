...
import { PHONE, PHONE_INTL, EMAIL } from '../config/constants';
          ...
          >
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <a href={`tel:+${PHONE}`} className="text-white/60 hover:text-accent transition-colors">
                  {PHONE_INTL}
                </a>
              </div>
              <div className="flex items-start gap-3">
                ...
                <a href={`https://wa.me/${PHONE}`} target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-accent transition-colors">
                  WhatsApp
                </a>
              </div>
              <div className="flex items-start gap-3">
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/40 text-sm">
            © {new Date().getFullYear()} FAPPK — Ferme Agropastorale Petit Kouassi de Niablé. Tous droits réservés. Powered by{' '}
              <a className="text-primary hover:text-accent transition-colors" href="mailto:nivaquine@yahoo.com">
                nivaQuine
              </a>
          </p>
