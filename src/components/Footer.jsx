          ...
          >
            ...
            <div className="space-y-4 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <a href="tel:+2250708313132" className="text-white/60 hover:text-accent transition-colors">
                  +225 07 08 31 31 32
                </a>
              </div>
              <div className="flex items-start gap-3">
                ...
                <a href="https://wa.me/2250708313132" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-accent transition-colors">
                  WhatsApp
                </a>
              </div>
            </div>
